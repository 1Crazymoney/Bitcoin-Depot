...
const strings = {
  ...
  login: 'Login',
  help_build: 'Build',
  help_modal_title: 'Bitcoin Depot Wallet',
  ...
  title_fio_pending_request_details: 'Pending Request Details',
  ...
  transaction_details_advance_details_custom_fee: 'Custom Fee',
  ...
  buy_parent_crypto_no_exchange_modal_message: '%1$s is required to send this transaction. Would you like to buy %1$s?',
  ...
  fio_address_domain_already_own: 'Use domain I already own',
  fio_address_register_screen_label: 'Create a unique FIO Address',
  fio_address_register_form_field_label: 'FIO Address',
  fio_address_register_screen_available: 'Available',
  ...
  fio_address_register_screen_invalid: 'Invalid name',
  ...
  fio_address_confirm_screen_disabled_slider_nowallet_label: 'Select a Wallet',
  fio_address_confirm_screen_button_register: 'Register',
  ...
  fio_no_bundled_err_title: 'Renew FIO Address',
  fio_renew_err_msg: 'There was an issue renewing your %s. Please try again later.',
  fio_renew_fee_label: 'Renewal Fee',
  fio_no_bundled_err_msg: 'Your FIO Address ran out of free transactions. Please renew your FIO Address.',
  ...
  fio_date_label: 'Date',
  fio_request_from_label: 'Request from',
  send_fio_request_dialog_title: 'Request by FIO Address',
